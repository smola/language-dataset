...
class HasParent extends AbstractFilter
{
     ...
     */
    public function __construct(var query, string type) -> void
    {
     ...
     */
    public function setQuery(query) -> <\Elastica\Filter\HasParent>
    {
        var data;
     ...
     * @return \Elastica\Filter\HasParent Current object
     */
    public function setFilter(<\Elastica\Filter\AbstractFilter> filter) -> <\Elastica\Filter\HasParent>
    {
        var data;
